...
class Game:
    ...
    def __init__(self, gamePk, timecode=None, tz="ct"):
        ...
        game_url = (
            f"{BASE}/v1.1/game/{self.game_id}/feed/live?hydrate=venue,flags,preState{timecodeQuery}"
        )
        ...
        self.__umpires = {
            "home": self.__ump_home,
            "first": self.__ump_first,
            "second": self.__ump_second,
            "third": self.__ump_third,
        }
    ...
    def boxscore(self, tz=None) -> dict:
        ...
        away = {
            "full": self.__away_team_full,
            "club": self.__away_team,
            "mlbam": self.away_id,
        }
        home = {
            "full": self.__home_team_full,
            "club": self.__home_team,
            "mlbam": self.home_id,
        }
    ...
    def diamond(self, print_as_df=True):
        ...
        diamond = {
            "pitcher": {
                "name": self.__curr_defense["pitcher"]["fullName"],
                "id": self.__curr_defense["pitcher"]["id"],
            },
            "catcher": {
                "name": self.__curr_defense["catcher"]["fullName"],
                "id": self.__curr_defense["catcher"]["id"],
            },
            "first": {
                "name": self.__curr_defense["first"]["fullName"],
                "id": self.__curr_defense["first"]["id"],
            },
            "second": {
                "name": self.__curr_defense["second"]["fullName"],
                "id": self.__curr_defense["second"]["id"],
            },
            "third": {
                "name": self.__curr_defense["third"]["fullName"],
                "id": self.__curr_defense["third"]["id"],
            },
            "shortstop": {
                "name": self.__curr_defense["shortstop"]["fullName"],
                "id": self.__curr_defense["shortstop"]["id"],
            },
            "left": {
                "name": self.__curr_defense["left"]["fullName"],
                "id": self.__curr_defense["left"]["id"],
            },
            "center": {
                "name": self.__curr_defense["center"]["fullName"],
                "id": self.__curr_defense["center"]["id"],
            },
            "right": {
                "name": self.__curr_defense["right"]["fullName"],
                "id": self.__curr_defense["right"]["id"],
            },
        }
    ...
    def matchup_info(self):
        ...
        * `zone`: current batter's strike zone metrics (tuple)
        ...
        try:
            ...
            zone_bot = self.__curr_play["playEvents"][-1]["pitchData"][
                "strikeZoneBottom"
            ]
        except:
        ...
        atBat = {
            ...
            "zone_bot": self.__players[f'ID{matchup["batter"]["id"]}'][
                "strikeZoneBottom"
            ],
